...
//    for(int k = 0; k < 8; k++)
//    {
//      Serial.print(frontArraySensorValues[k]);
//      Serial.print(" ");
//    }
//    Serial.println();
  }
...
void printColor(double r, double g, double b, double c)
{
  ...
  else if(r>10000 && r<16500 && g>17000 && g<24500 && b>6000 && b<13500)
  {
    Serial.println("color is green");//R: 0.33 G: 0.55 B: 0.28 color is grey
    color = 'g';
    
  }
  else if(r>2500 && r<8500 && g>7500 && g<12500 && b>12000 && b<18500)
  {
  ...
  else if(r>6800 && r<12000 && g>16000 && g<30000 && b>16000 && b<30000)
  {
    Serial.println("color is cyan"); //R: 0.21 G: 0.55 B: 0.59 color is grey
    color = 'c';
  }
  else if(r>2500 && r<7500 && g>3500 && g<8500 && b>3000 && b<8000)
  {
