...
//uses base speed for both motors
...
void ResetBlue(){resetCarouselDouble();};
void ResetRed(){resetCarouselDouble();};
void ResetGreen(){resetCarouselDouble();};
void ResetCyan(){resetCarouselDouble();};
