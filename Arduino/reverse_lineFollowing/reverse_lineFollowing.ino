...
//    assignSpeed(MotorR, MotorL);
    ...
    while(position > 4000)
    {
      ...
      hardStop();
      delay(500);
      position = qtraFront.readLine(frontArraySensorValues);
    }
...
////    Serial.print("  front:");
////    Serial.print("   back:");
////    Serial.print(qtraBack.readLine(backArraySensorValues));
//    Serial.print("   right:");
//    Right.readCalibrated(RsensorValue);
//    Serial.print(RsensorValue[0]);
//    Serial.print("   left:");
//    Left.readCalibrated(LsensorValue);
//    Serial.println(LsensorValue[0]);
//    delay(500);
