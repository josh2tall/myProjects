...
void loop()
{
  ...
  else
  {
    ...
    switch(counter)
    {
      ...
      case 20:                            //turning into inner loop// reverses to align
...
void adjustPosition(int mode)
{
  ...
  if(mode == 0)
  {
    while(frontPosition > 4000 || frontPosition < 3000)
    {
      frontPosition = qtraFront.readLine(frontArraySensorValues);
      if(frontPosition > 3700)
      {
        LReverse();
        RForward();
        assignSpeed(MotorR, MotorL);
